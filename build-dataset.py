...
stockDir =['stocks/random-stocks', 'stocks/f500']
startDates = [date(2008, 9, 22), date(2003, 9, 22)]
endDates = [date(2013, 9, 18), date(2013, 9, 18)]
outputFilenames = ['stocks/random-stocks.csv', 'stocks/fortune-500.csv']
...
for did, directory in enumerate(stockDir):
    outputFilename = outputFilenames[did]
    startDate = startDates[did]
    endDate = endDates[did]
    stocks = {}
    print("----", directory, "-----")    

...
def payoffGraph(table, tickers, cumulative=True, imgfile='images/graph.png'):
   ...
   if cumulative:
      plt.title("Cumulative stock rewards over time"+":"+imgfile)
   else:
      plt.title("Stock rewards over time"+":"+imgfile)
